    ...
    public class S1TableConfig
    {
        ...
        public bool Load(string text)
        {
            ...
            for (int i = 0; i < jsonData.Count; i++)
            {
                ...
                S1Table TableInstance = new S1Table();
        ...
        private List<S1Table> m_kDatas = new List<S1Table>();
        private Dictionary<int, S1Table> m_kMapDatas = new Dictionary<int, S1Table>();
    }
}
